...
SECRET_KEY = 'django-insecure-udorv&)-95@8f%432=i$y^$&8k*3acse#1=+&l0u=2-ev(#oo4'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        ...
        'rest_framework.authentication.BasicAuthentication',    # Optional, for non‑browser clients
    ],
    # Other DRF settings…
}
